    ...
    return (
      <div className="termsWrapper">
        ...
        <div className="docu">
            ...
            <li>"회원"이 서비스를 이용하여 통신판매 또는 통신판매중개를 업으로 하는 경우 전자상거래등에서의소비자보호에관한법률에 따른 의무를 준수하여야 하며, 회사는 개별 서비스 이용약관 및 정책에서 관련 내용을 규정할 수 있습니다.</li></ol>
        </div>
        ...
        <div className="docu">
            ...
            <li>해외에 주소나 거소가 있는 "회원"의 경우 "회사"와 "회원"간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할법원으로 합니다.</li></ol>
        </div>

        <div className="docu">
            <h2 className="header">부칙</h2>
            <ol className="olbody">
                <li>이 약관은 2021년 6월 13일부터 적용됩니다.</li>
            </ol>
        </div>
