    ...
    return (
      <div className="termsWrapper">
        ...
        <div className="termsheader">
            <h1 className="termstitle">이용약관</h1>
        </div>

        <div className="docu">
            <h2 className="header">제 1 조 (목적)</h2>
            이 약관은 (주)DDH 및 보시쇼 서비스 그룹 (이하 "회사")가 제공하는 See-show 및 See-show 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
        </div>

        <div className="docu">
            <h2 className="header">제 2 조 (정의)</h2>
            이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
            <ol>
                <li>"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 네이버 및 네이버 관련 제반 서비스를 의미합니다.</li>
        ...
        <div className="docu">
            <h2 className="header">제 3 조 (약관의 게시와 개정)</h2>
            <ol>
                ...
                <li>"회사"가 약관을 개정할 경우에는 적용일 및 사유를 명시하여 현행약관과 함께 제1항의 방식에 따라 개정약관의 적용일자 30일 전부터 적용일까지 공지합니다. 다만, 회원에게 불리한 약관의 개정의 경우에는 공지 외에 일정기간 서비스내 전자적 수단을 통해 따로 명확히 통지하도록 합니다.</li>
        ...
        <div className="docu">
            <h2 className="header">제 4 조 (약관의 해석)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 5 조 (이용계약 체결)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 6 조 (회원정보의 변경)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 8 조 ("회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 9 조 ("회원"에 대한 통지)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 10 조 ("회사"의 의무)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 11 조 ("회원"의 의무)</h2>
            <ol>1.	"회원"은 다음 행위를 하여서는 안 됩니다.</ol>
                <ol>
                ...
                <li>기타 불법적이거나 부당한 행위</li></ol>
            <ol>2.	"회원"은 관계법, 이 약관의 규정, 이용안내 및 "서비스"와 관련하여 공지한 주의사항, "회사"가 통지하는 사항 등을 준수하여야 하며, 기타 "회사"의 업무에 방해되는 행위를 하여서는 안 됩니다.</ol>
            <ol>3.	"회원"이 서비스를 이용하여 통신판매 또는 통신판매중개를 업으로 하는 경우 전자상거래등에서의소비자보호에관한법률에 따른 의무를 준수하여야 하며, 회사는 개별 서비스 이용약관 및 정책에서 관련 내용을 규정할 수 있습니다.</ol>
        </div>

        <div className="docu">
            <h2 className="header">제 12 조 ("서비스"의 제공 등)</h2>
            <ol>
            ...
            <li>"회사"는 설비의 점검, 교체, 고장, 통신두절 또는 운영상 사유가 있는 경우 "서비스"의 제공을 일시적으로 중단할 수 있습니다. 이 경우 "회사"는 제9조["회원"에 대한 통지]에 정한 방법으로 "회원"에게 통지하나, "회사"가 사전에 통지할 수 없는 부득이한 사유가 있는 경우 사후에 통지할 수 있습니다.</li>
            <li>"회사"는 서비스의 제공에 필요한 경우 정기점검을 실시할 수 있으며, 정기점검시간은 서비스제공화면에 공지한 바에 따릅니다.</li>
            </ol>
        </div>

        <div className="docu">
            <h2 className="header">제 13 조 ("서비스"의 변경)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 14 조 (정보의 제공 및 광고의 게재)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 15 조 ("게시물"의 저작권)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 16 조 ("게시물"의 관리)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 17 조 (권리의 귀속)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 19 조 (계약해제, 해지 등)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 20 조 (이용제한 등)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 21 조 (책임제한)</h2>
            <ol>
        ...
        <div className="docu">
            <h2 className="header">제 22 조 (준거법 및 재판관할)</h2>
            <ol>1.	"회사"와 "회원" 간 제기된 소송은 대한민국법을 준거법으로 합니다.</ol>
            <ol>2.	"회사"와 "회원"간 발생한 분쟁에 관한 소송은 제소 당시의 "회원"의 주소에 의하고, 주소가 없는 경우 거소를 관할하는 지방법원의 전속관할로 합니다. 단, 제소 당시 "회원"의 주소 또는 거소가 명확하지 아니한 경우의 관할법원은 민사소송법에 따라 정합니다.</ol>
            <ol>3.	해외에 주소나 거소가 있는 "회원"의 경우 "회사"와 "회원"간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할법원으로 합니다.</ol>
        </div>

        <div className="docu">
            <h2 className="header">부칙</h2>
            <ol>1.	이 약관은 2021년 6월 13일부터 적용됩니다.</ol>
        </div>
